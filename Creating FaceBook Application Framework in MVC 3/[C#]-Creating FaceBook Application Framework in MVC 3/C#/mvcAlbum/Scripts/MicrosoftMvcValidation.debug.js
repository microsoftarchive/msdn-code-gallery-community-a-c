...
Sys.Mvc.FormContext = function Sys_Mvc_FormContext(formElement, validationSummaryElement) {
    ...
    /// </field>
    /// <field name="replacmvcidationSummary" type="Boolean">
    /// </field>
    this._errors = [];
...
Sys.Mvc.FormContext._parseJsonOptions = function Sys_Mvc_FormContext$_parseJsonOptions(options) {
    ...
    formContext.replacmvcidationSummary = options.ReplacmvcidationSummary;
    for (var i = 0; i < options.Fields.length; i++) {
        ...
        fieldContext.replacmvcidationMessageContents = field.ReplacmvcidationMessageContents;
...
Sys.Mvc.FormContext.prototype = {
    ...
    _form_OnSubmit: function Sys_Mvc_FormContext$_form_OnSubmit(e) {
        ...
        if (submitButton && submitButton.disablmvcidation) {
            return;
        }
    ...
    validate: function Sys_Mvc_FormContext$validate(eventName) {
        ...
        if (this.replacmvcidationSummary) {
            this.clearErrors();
...
Sys.Mvc.FieldContext = function Sys_Mvc_FieldContext(formContext) {
    ...
    /// </field>
    /// <field name="_validationMessagmvcidCss" type="String" static="true">
    /// </field>
    ...
    /// </field>
    /// <field name="replacmvcidationMessageContents" type="Boolean">
    /// </field>
...
Sys.Mvc.FieldContext.prototype = {
    ...
    formContext: null,
    replacmvcidationMessageContents: false,
    ...
    _displayError: function Sys_Mvc_FieldContext$_displayError() {
        ...
        if (validationMessageElement) {
            if (this.replacmvcidationMessageContents) {
                Sys.Mvc._validationUtil.setInnerText(validationMessageElement, this._errors[0]);
            }
            Sys.UI.DomElement.removeCssClass(validationMessageElement, Sys.Mvc.FieldContext._validationMessagmvcidCss);
    ...
    _displaySuccess: function Sys_Mvc_FieldContext$_displaySuccess() {
        ...
        if (validationMessageElement) {
            ...
            Sys.UI.DomElement.addCssClass(validationMessageElement, Sys.Mvc.FieldContext._validationMessagmvcidCss);
        }
        var elements = this.elements;
        for (var i = 0; i < elements.length; i++) {
            var element = elements[i];
...
////////////////////////////////////////////////////////////////////////////////
// Sys.Mvc.Rangmvcidator

Sys.Mvc.Rangmvcidator = function Sys_Mvc_Rangmvcidator(minimum, maximum) {
...
Sys.Mvc.Rangmvcidator.create = function Sys_Mvc_Rangmvcidator$create(rule) {
    /// <param name="rule" type="Sys.Mvc.JsonValidationRule">
    /// </param>
    /// <returns type="Sys.Mvc.Validator"></returns>
    var min = rule.ValidationParameters['min'];
    var max = rule.ValidationParameters['max'];
    return Function.createDelegate(new Sys.Mvc.Rangmvcidator(min, max), new Sys.Mvc.Rangmvcidator(min, max).validate);
}
Sys.Mvc.Rangmvcidator.prototype = {
    _minimum: null,
    _maximum: null,
    
    validate: function Sys_Mvc_Rangmvcidator$validate(value, context) {
        /// <param name="value" type="String">
        /// </param>
        /// <param name="context" type="Sys.Mvc.ValidationContext">
        /// </param>
...
Sys.Mvc.ValidatorRegistry._getDefaultValidators = function Sys_Mvc_ValidatorRegistry$_getDefaultValidators() {
    /// <returns type="Object"></returns>
    return { required: Function.createDelegate(null, Sys.Mvc.RequiredValidator.create), length: Function.createDelegate(null, Sys.Mvc.StringLengthValidator.create), regex: Function.createDelegate(null, Sys.Mvc.RegularExpressionValidator.create), range: Function.createDelegate(null, Sys.Mvc.Rangmvcidator.create), number: Function.createDelegate(null, Sys.Mvc.NumberValidator.create) };
}
...
Sys.Mvc.Rangmvcidator.registerClass('Sys.Mvc.Rangmvcidator');
...
Sys.Mvc.FieldContext._validationMessagmvcidCss = 'field-validation-valid';
