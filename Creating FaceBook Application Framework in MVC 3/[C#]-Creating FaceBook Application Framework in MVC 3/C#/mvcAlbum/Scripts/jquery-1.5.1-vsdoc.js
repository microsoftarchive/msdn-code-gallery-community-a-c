...
jQuery.extend({
	...
	// mvculates a script in a global context
	globalmvc: function( data ) {
		///	<summary>
		///     &#10;Internally mvcuates a script in a global context.
		///	</summary>
		///	<private />

		if ( data && rnotwhite.test(data) ) {
			// Inspired by code by Andrea Giammarchi
			// http://webreflection.blogspot.com/2007/08/global-scope-mvcuation-and-dom.html
			var head = document.getElementsByTagName("head")[0] || document.documentElement,
				script = document.createElement("script");

			script.type = "text/javascript";

			if ( jQuery.support.scriptmvc ) {
...
jQuery.fn.extend({
	...
	toggleClass: function( value, statmvc ) {
		///	<summary>
		...
		///	</param>
		///	<param name="statmvc" type="Object">
		///     &#10;A boolean value to determine whether the class should be added or removed.
		///	</param>
		///	<returns type="jQuery" />

		var type = typeof value,
			isBool = typeof statmvc === "boolean";

		if ( jQuery.isFunction( value ) ) {
			return this.each(function(i) {
				var self = jQuery(this);
				self.toggleClass( value.call(this, i, self.attr("class"), statmvc), statmvc );
			});
		}
	...
	attr: function( elem, name, value, pass ) {
		...
		if ( (name in elem || elem[ name ] !== undefined) && notxml && !special ) {
			...
			if ( jQuery.nodeName( elem, "form" ) && elem.getAttributeNode(name) ) {
				return elem.getAttributeNode( name ).nodmvcue;
			}
	...
	//	if ( document.getElementById( id ) ) {
		Expr.find.ID = function( match, context, isXML ) {
			if ( typeof context.getElementById !== "undefined" && !isXML ) {
				...
				return m ?
					m.id === match[1] || typeof m.getAttributeNode !== "undefined" && m.getAttributeNode("id").nodmvcue === match[1] ?
						[m] :
						undefined :
					[];
			}
		...
		Expr.filter.ID = function( elem, match ) {
			...
			return elem.nodeType === 1 && node && node.nodmvcue === match;
		};
	//	}
...
var runtil = /Until$/,
	rparentsprev = /^(?:parents|prevUntil|prmvcl)/,
...
function mvcScript( i, elem ) {
	...
	if ( elem.src ) {
		...
		jQuery.globalmvc( elem.text || elem.textContent || elem.innerHTML || "" );
	}
...
jQuery.extend({
	...
	httpData: function( xhr, type, s ) {
		...
		if ( typeof data === "string" ) {
			...
			// If the type is "script", mvc it in global context
			} else if ( type === "script" || !type && ct.indexOf("javascript") >= 0 ) {
				jQuery.globalmvc( data );
			}
		}
