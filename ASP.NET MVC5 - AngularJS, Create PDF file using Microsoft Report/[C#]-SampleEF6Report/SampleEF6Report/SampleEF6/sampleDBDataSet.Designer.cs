...
namespace SampleEF6 {
    ...
    public partial class sampleDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ContactsRow AddContactsRow(string Name, string Address, string City, string Country) {
...
namespace SampleEF6.sampleDBDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contacts] ([Name], [Address], [City], [Country]) VALUES (@Name" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Contacts] SET [Name] = @Name, [Address] = @Address, [City] = @City," +
                " [Country] = @Country WHERE (([Id] = @Original_Id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Address, City, Country FROM dbo.Contacts";
        ...
        public virtual int Fill(sampleDBDataSet.ContactsDataTable dataTable) {
        ...
        public virtual sampleDBDataSet.ContactsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            sampleDBDataSet.ContactsDataTable dataTable = new sampleDBDataSet.ContactsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(sampleDBDataSet.ContactsDataTable dataTable) {
        ...
        public virtual int Insert(string Name, string Address, string City, string Country) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Address, string City, string Country, int Original_Id) {
            if ((Name == null)) {
