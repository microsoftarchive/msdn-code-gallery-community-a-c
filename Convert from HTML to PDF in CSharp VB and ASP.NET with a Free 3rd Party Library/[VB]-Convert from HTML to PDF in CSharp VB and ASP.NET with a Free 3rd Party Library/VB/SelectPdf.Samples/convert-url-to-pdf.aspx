<%@ Page Title="" Language="vb" MasterPageFile="~/Samples.Master" AutoEventWireup="true" CodeBehind="convert-url-to-pdf.aspx.vb" Inherits="SelectPdf.Samples.SelectPdf.Samples.convert_url_to_pdf" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>SelectPdf Free Html To Pdf Converter for .NET VB.NET / ASP.NET - Convert from Url to Pdf</title>
    <meta name="description" content="SelectPdf Free Html To Pdf Converter - Convert from Url to Pdf Sample for VB.NET / ASP.NET. Pdf Library for .NET with full sample code in C# and VB.NET." itemprop="description">
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
        <article class="post type-post status-publish format-standard hentry">
            <header class="entry-header">
                <h1 class="entry-title">SelectPdf Free Html To Pdf Converter - Convert from Url to Pdf - VB.NET / ASP.NET Sample</h1>
            </header>
            <!-- .entry-header -->
