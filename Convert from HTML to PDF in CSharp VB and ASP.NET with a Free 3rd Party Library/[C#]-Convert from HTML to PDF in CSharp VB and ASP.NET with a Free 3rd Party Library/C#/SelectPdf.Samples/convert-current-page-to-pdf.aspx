...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>SelectPdf Free Html To Pdf Converter for .NET C# / ASP.NET - Convert Current Asp.Net Page to Pdf</title>
    <meta name="description" content="SelectPdf Free Html To Pdf Converter - Convert Current Asp.Net Page to Pdf Sample for C# / ASP.NET. Pdf Library for .NET with full sample code in C# and VB.NET." itemprop="description">
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
        <article class="post type-post status-publish format-standard hentry">
            <header class="entry-header">
                <h1 class="entry-title">SelectPdf Free Html To Pdf Converter - Convert Current Asp.Net Page to Pdf - C# / ASP.NET Sample</h1>
            </header>
            <!-- .entry-header -->
