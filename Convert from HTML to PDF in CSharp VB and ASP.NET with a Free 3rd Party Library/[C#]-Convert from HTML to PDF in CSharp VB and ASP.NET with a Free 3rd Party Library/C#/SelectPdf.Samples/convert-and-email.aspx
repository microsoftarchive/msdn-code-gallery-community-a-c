<%@ Page Title="" Language="C#" MasterPageFile="~/Samples.Master" AutoEventWireup="true" CodeBehind="convert-and-email.aspx.cs" Inherits="SelectPdf.Samples.convert_and_email" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>SelectPdf Free Html To Pdf Converter for .NET - Html to Pdf Converter - Convert and Email as Attachment - C# / ASP.NET</title>
    <meta name="description" content="SelectPdf Free Html To Pdf Converter. Convert and Email as Attachment Sample for C# ASP.NET. Pdf Library for .NET with full sample code in C# and VB.NET." itemprop="description">
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
        <article class="post type-post status-publish format-standard hentry">
            <header class="entry-header">
                <h1 class="entry-title">SelectPdf Free Html To Pdf Converter for .NET - Convert and Email as Attachment - C# / ASP.NET Sample</h1>
            </header>
            <!-- .entry-header -->
