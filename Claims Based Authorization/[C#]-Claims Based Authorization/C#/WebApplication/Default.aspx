...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <section class="featured">
        <div class="content-wrapper">
            ...
            <p>
                This sample shows use of claims for authorization within an ASP.Net Web Application. For a more complete explanation of how the sample works, 
                please refer to the readme.html file in the VS solution or to the sample’s <a href="http://code.msdn.microsoft.com/Claims-Based-Authorization-89cf736e">online description</a>.
            </p>
        </div>
    </section>
</asp:Content>
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p>
        ...
        Authorization Manager that is part of WIF.
    </p>
    <h3>Your claims</h3>
    <p>
