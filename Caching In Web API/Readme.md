...
<p><span style="font-size:small">In this article we will are going to learn how we can use caching in Web API. Normally caching is the process of storing data somewhere for the future requests, in our case we can avoid the unwanted hit to database to get the
 ...
 it here:&nbsp;<a href="http://sibeeshpassion.com/caching-in-mvc/" target="_blank">Caching In MVC</a>. We will explain caching with the help of&nbsp;<em>System.Runtime.Caching</em>&nbsp;which is given by Microsoft. This DLL is not available in the default references,
...
<p><span style="font-size:small">Once your application is ready, we can add the reference for&nbsp;<em>System.Runtime.Caching</em></span></p>
<p><strong><span style="font-size:small">Add reference for System.Runtime.Caching</span></strong></p>
...
<p><span style="font-size:small">Now click on the browse button, and search for&nbsp;<em>System.Runtime.Caching</em></span></p>
...
<p><span style="font-size:small">Now we will start testing our caching. For that please import the namespace&nbsp;<em>System.Runtime.Caching;</em></span></p>
<div>
...
<div class="pluginLinkHolder"><span class="pluginEditHolderLink">Edit</span>|<span class="pluginRemoveHolderLink">Remove</span></div>
<span class="hidden">csharp</span>
<pre class="hidden">using System.Runtime.Caching;
</pre>
<div class="preview">
<pre class="js">using&nbsp;System.Runtime.Caching;&nbsp;
</pre>
</div>
</div>
</div>
