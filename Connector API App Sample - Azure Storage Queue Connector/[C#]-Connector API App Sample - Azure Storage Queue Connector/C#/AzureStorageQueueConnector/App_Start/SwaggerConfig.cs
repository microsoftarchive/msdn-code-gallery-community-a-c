...
using AzureStorageQueueConnector;
...
namespace AzureStorageQueueConnector
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "AzureStorageQueueConnector");
                        ...
                        // Operation filters.
                        //
                        c.OperationFilter<AddDefaultResponseFilter>();
                        c.OperationFilter<DiscoverQueueFilter>();
    ...
    public class AddDefaultResponseFilter : IOperationFilter
    {
    ...
    public class DiscoverQueueFilter : IOperationFilter
    {
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, System.Web.Http.Description.ApiDescription apiDescription)
        {
            ...
            if (param != null)
            {
                ...
                {
                    param.@enum.Add(queueName);
                }
            }
        }

        private System.Collections.Generic.IEnumerable<string> GetQueues()
        {
