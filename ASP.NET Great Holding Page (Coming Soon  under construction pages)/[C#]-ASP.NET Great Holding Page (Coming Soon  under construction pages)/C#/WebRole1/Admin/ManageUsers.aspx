...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="width_3_quarter" 
      ...
      <p align="center" style="width: 889px">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <asp:Panel ID="Panel3" runat="server">
            <asp:Panel ID="Panel2" runat="server" CssClass="width_half" 
                HorizontalAlign="Left">
                <asp:Label ID="Label1" runat="server" Text="Member's Name:"></asp:Label>
                &nbsp;
                <asp:TextBox ID="tbMembersName" runat="server" ontextchanged="textChanged" 
                    ViewStateMode="Enabled"></asp:TextBox>
                <br />
                <asp:Label ID="Label2" runat="server" Text="Password:"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="tbPassword" runat="server" ontextchanged="textChanged" 
                    TextMode="Password" ViewStateMode="Enabled"></asp:TextBox>
                <br />
                <asp:Label ID="Label3" runat="server" Text="Email Address:"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="tbEmailAddress" runat="server" ontextchanged="textChanged" 
                    ValidationGroup="Email" ViewStateMode="Enabled"></asp:TextBox>
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <asp:Panel ID="panelMessages" runat="server" Visible="false">
                    <asp:Label ID="lblMessages" runat="server" CssClass="alert_info" Text="Label"></asp:Label>
                </asp:Panel>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ControlToValidate="tbEmailAddress" ErrorMessage="RegularExpressionValidator" 
     ...
     <asp:Panel ID="panelRoles" runat="server" CssClass="width_half" 
            HorizontalAlign="Left">
