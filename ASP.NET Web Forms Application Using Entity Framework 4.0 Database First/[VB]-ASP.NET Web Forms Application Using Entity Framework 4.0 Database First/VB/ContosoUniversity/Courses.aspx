<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Courses.aspx.vb" Inherits="ContosoUniversity.Courses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<asp:EntityDataSource ID="DepartmentsEntityDataSource" runat="server" ContextTypeName="ContosoUniversity.SchoolEntities"
	...
	<asp:EntityDataSource ID="CoursesEntityDataSource" runat="server" ContextTypeName="ContosoUniversity.SchoolEntities"
	...
	<br />
	<br />
	<asp:EntityDataSource ID="SearchEntityDataSource" runat="server" ContextTypeName="ContosoUniversity.SchoolEntities"
