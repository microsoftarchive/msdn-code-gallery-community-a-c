...
{
    public class HttpPostRequestModel : PageModel
    {
        public void OnGet()
        {
            TxtUrl = Helper.WWWRoot(Request) + Url.Content("~/ViewHttpPostData");
        }
        ...
        public IActionResult OnPost()
        {
            ...
            converter.Options.HttpPostParameters.Add(TxtName1, TxtValue1);
            converter.Options.HttpPostParameters.Add(TxtName2, TxtValue2);
            converter.Options.HttpPostParameters.Add(TxtName3, TxtValue3);
            converter.Options.HttpPostParameters.Add(TxtName4, TxtValue4);
