...
{
    public class HttpHeadersModel : PageModel
    {
        public void OnGet()
        {
            TxtUrl = Helper.WWWRoot(Request) + Url.Content("~/ViewHttpHeaders");
        }
        ...
        public IActionResult OnPost()
        {
            ...
            converter.Options.HttpHeaders.Add(TxtName1, TxtValue1);
            converter.Options.HttpHeaders.Add(TxtName2, TxtValue2);
            converter.Options.HttpHeaders.Add(TxtName3, TxtValue3);
            converter.Options.HttpHeaders.Add(TxtName4, TxtValue4);
