...
class CyrillicToRomanFallback : EncoderFallback 
{
   private Dictionary<Char, String> table; 

   public CyrillicToRomanFallback()
   {
...
public class CyrillicToRomanFallbackBuffer : EncoderFallbackBuffer
{
   private Dictionary<Char, String> table;
   ...
   internal CyrillicToRomanFallbackBuffer(Dictionary<Char, String> table)
   {
      this.table = table;
      this.bufferIndex = -1;
      this.leftToReturn = -1;
