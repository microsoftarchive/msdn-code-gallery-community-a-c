...
namespace ClientApp
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void NavigateListPageButton_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(ListPage));
        }

        private void NavigationFunctionPageButton_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(FunctionActionPage));
        }
    }
}
