...
<Assembly: EdmSchemaAttribute("bdd94aa8-afc9-46cf-8a34-156dabb191c6")>
...
<Assembly: EdmRelationshipAttribute("SchoolModel", "FK_Department_Person", "Person", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(Person), "Department", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(Department), True)>
...
Public Partial Class SchoolEntities
    ...
    ''' No Metadata Documentation available.
    ''' </summary>
    Public ReadOnly Property InstructorNames() As ObjectSet(Of InstructorName)
        Get
            If (_InstructorNames Is Nothing) Then
                _InstructorNames = MyBase.CreateObjectSet(Of InstructorName)("InstructorNames")
            End If
            Return _InstructorNames
        End Get
    End Property

    Private _InstructorNames As ObjectSet(Of InstructorName)
    ...
    ''' <summary>
    ''' Deprecated Method for adding a new object to the InstructorNames EntitySet. Consider using the .Add method of the associated ObjectSet(Of T) property instead.
    ''' </summary>
    Public Sub AddToInstructorNames(ByVal instructorName As InstructorName)
        MyBase.AddObject("InstructorNames", instructorName)
    End Sub
    ...
    ''' No Metadata Documentation available.
    ''' </summary>
    Public Function GetCourses() As ObjectResult(Of Course)
        Return MyBase.ExecuteFunction(Of Course)("GetCourses")
    ...
    Public Function GetCourses(mergeOption As MergeOption) As ObjectResult(Of Course)
        Return MyBase.ExecuteFunction(Of Course)("GetCourses", mergeOption)
...
Public Partial Class Department
    ...
    Public Property Person() As Person
        Get
            Return CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of Person)("SchoolModel.FK_Department_Person", "Person").Value
        End Get
        Set
            CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of Person)("SchoolModel.FK_Department_Person", "Person").Value = value
        End Set
    End Property
    ''' <summary>
    ''' No Metadata Documentation available.
    ...
    Public Property PersonReference() As EntityReference(Of Person)
        Get
            Return CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of Person)("SchoolModel.FK_Department_Person", "Person")
        End Get
        Set
            If (Not value Is Nothing)
                CType(Me, IEntityWithRelationships).RelationshipManager.InitializeRelatedReference(Of Person)("SchoolModel.FK_Department_Person", "Person", value)
            End If
        End Set
    End Property
...
Public Partial Class Instructor
    ...
    Public Shared Function CreateInstructor(personID As Global.System.Int32, lastName As Global.System.String, firstMidName As Global.System.String, hireDate As Global.System.DateTime) As Instructor
...
<Serializable()>
<DataContractAttribute(IsReference:=True)>
Public Partial Class InstructorName
    Inherits EntityObject
    #Region "Factory Method"
    ...
    ''' <param name="personID">Initial value of the PersonID property.</param>
    Public Shared Function CreateInstructorName(fullName As Global.System.String, personID As Global.System.Int32) As InstructorName
        Dim instructorName as InstructorName = New InstructorName
...
Public MustInherit Partial Class Person
    ...
    <EdmScalarPropertyAttribute(EntityKeyProperty:=false, IsNullable:=false)>
    <DataMemberAttribute()>
    Public Property FirstMidName() As Global.System.String
        Get
    ...
    Private _FirstMidName As Global.System.String
    Private Partial Sub OnFirstMidNameChanging(value As Global.System.String)
    End Sub

    Private Partial Sub OnFirstMidNameChanged()
    End Sub
    ...
    <EdmRelationshipNavigationPropertyAttribute("SchoolModel", "FK_Department_Person", "Department")>
     Public Property Departments() As EntityCollection(Of Department)
        Get
            Return CType(Me,IEntityWithRelationships).RelationshipManager.GetRelatedCollection(Of Department)("SchoolModel.FK_Department_Person", "Department")
        End Get
        Set
            If (Not value Is Nothing)
                CType(Me, IEntityWithRelationships).RelationshipManager.InitializeRelatedCollection(Of Department)("SchoolModel.FK_Department_Person", "Department", value)
            End If
        End Set
    End Property
...
Public Partial Class Student
    ...
    Public Shared Function CreateStudent(personID As Global.System.Int32, lastName As Global.System.String, firstMidName As Global.System.String, enrollmentDate As Global.System.DateTime) As Student
    ...
    <EdmScalarPropertyAttribute(EntityKeyProperty:=false, IsNullable:=false)>
    <DataMemberAttribute()>
    Public Property EnrollmentDate() As Global.System.DateTime
        Get
    ...
    Private _EnrollmentDate As Global.System.DateTime
    Private Partial Sub OnEnrollmentDateChanging(value As Global.System.DateTime)
    End Sub
