<%@ Page Title="" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateCredits.aspx.vb" Inherits="ContosoUniversity.UpdateCredits" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<br /><br /> 
	<asp:Button ID="ExecuteButton" runat="server" Text="Execute" /><br /><br /> 
	Rows affected: 
