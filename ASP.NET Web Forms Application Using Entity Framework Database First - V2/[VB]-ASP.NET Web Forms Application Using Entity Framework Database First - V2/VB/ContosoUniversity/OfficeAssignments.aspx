<%@ Page Title="" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OfficeAssignments.aspx.vb" Inherits="ContosoUniversity.OfficeAssignments" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	 <h2>Office Assignments</h2> 
	<asp:ObjectDataSource ID="OfficeAssignmentsObjectDataSource" runat="server" TypeName="ContosoUniversity.SchoolBL" 
		DataObjectTypeName="ContosoUniversity.OfficeAssignment" SelectMethod="GetOfficeAssignments" 
