<%@ Page Title="" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Departments.aspx.vb" Inherits="ContosoUniversity.Departments" %>
	...
	<asp:GridView ID="DepartmentsGridView" runat="server" AutoGenerateColumns="False" 
		...
		<Columns> 
			...
			<asp:TemplateField HeaderText="Administrator" SortExpression="Person.LastName" ItemStyle-VerticalAlign="Top" > 
				...
				<EditItemTemplate> 
					<asp:ObjectDataSource ID="InstructorsObjectDataSource" runat="server" DataObjectTypeName="ContosoUniversity.InstructorName" 
						SelectMethod="GetInstructorNames" TypeName="ContosoUniversity.SchoolBL"> 
					</asp:ObjectDataSource> 
