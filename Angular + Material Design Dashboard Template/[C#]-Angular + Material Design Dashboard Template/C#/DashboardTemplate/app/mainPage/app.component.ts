...
export class AppComponent {
    ...
    loadRegionStats(id, regionname) {
        this.selectedRegion = id;

        this.appService.getINQStatsData("internetusers_percent,birth_rate,gdp_capita,hdi", regionname).subscribe(
            (data) => {
