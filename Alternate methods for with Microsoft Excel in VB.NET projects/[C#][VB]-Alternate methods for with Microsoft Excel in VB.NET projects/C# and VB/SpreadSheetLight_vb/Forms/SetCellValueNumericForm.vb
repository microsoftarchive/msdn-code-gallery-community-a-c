...
Public Class SetCellValueNumericForm
        ...
        Else
            Using sl As New SLDocument(fileName)
                ...
                If SLConvert.ToColumnIndex(cellAddressTextBox.Text) <> -1 Then
                    ...
                    sl.SetCellValue(cellAddressTextBox.Text, cellValueTextBox.AsInteger)
    ...
    Private Sub SetCellValueNumericForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Using sl As New SLDocument(fileName)
