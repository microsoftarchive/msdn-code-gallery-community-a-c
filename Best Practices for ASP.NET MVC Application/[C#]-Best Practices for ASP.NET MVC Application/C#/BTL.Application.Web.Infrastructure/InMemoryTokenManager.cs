...
namespace BTL.Application.Web.Infrastructure
{
    ...
    public class InMemoryTokenManager : IConsumerTokenManager, IOpenIdOAuthTokenManager
    {
        ...
        /// <remarks>
        ///   Request tokens stored by this method SHOULD NOT associate any user account with this token. It usually opens up security holes in your application to do so. Instead, you associate a user account with access tokens (not request tokens) in the <see
        ///    cref="ExpireRequestTokenAndStoreNewAccessToken" /> method.
        /// </remarks>
        ...
        /// <remarks>
        ///   <para>Any scope of granted privileges associated with the request token from the
        ///     original call to
        ///     <see cref="StoreNewRequestToken" />
        ///     should be carried over
        ///     to the new Access Token.</para> <para>To associate a user account with the new access token,
        ...
        ///                                       return the access
        ///                                       token to associate the access token with a user account at that point.</para>
        /// </remarks>
        ...
        /// <remarks>
        ///   <para>The token secret is the empty string.</para> <para>Tokens stored by this method should be short-lived to mitigate
