...
Partial Public Class NORTHWNDDataSet
    ...
    Partial Public Class CustomersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Overloads Function AddCustomersRow(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal PostalCode As String, ByVal Country As String) As CustomersRow
            Dim rowCustomersRow As CustomersRow = CType(Me.NewRow, CustomersRow)
            Dim columnValuesArray() As Object = New Object() {CompanyName, ContactName, ContactTitle, Address, City, PostalCode, Country, Nothing}
...
Namespace NORTHWNDDataSetTableAdapters
    ...
    Partial Public Class CustomersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Customers] WHERE (([CompanyName] = @Original_CompanyName) AND ((@IsN" & _
                "ull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_Con" & _
                "tactName)) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] IS NULL) OR ([Conta" & _
                "ctTitle] = @Original_ContactTitle)) AND ((@IsNull_Address = 1 AND [Address] IS N" & _
                "ULL) OR ([Address] = @Original_Address)) AND ((@IsNull_City = 1 AND [City] IS NU" & _
                "LL) OR ([City] = @Original_City)) AND ((@IsNull_PostalCode = 1 AND [PostalCode] " & _
                "IS NULL) OR ([PostalCode] = @Original_PostalCode)) AND ((@IsNull_Country = 1 AND" & _
                " [Country] IS NULL) OR ([Country] = @Original_Country)) AND ([Identfier] = @Orig" & _
                "inal_Identifier))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Customers] ([CompanyName], [ContactName], [ContactTitle], [Address]," & _
                " [City], [PostalCode], [Country]) VALUES (@CompanyName, @ContactName, @ContactTi" & _
                "tle, @Address, @City, @PostalCode, @Country);" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "SELECT CompanyName, ContactName, " & _
                "ContactTitle, Address, City, PostalCode, Country, Identfier AS Identifier FROM C" & _
                "ustomers WHERE (Identfier = SCOPE_IDENTITY()) ORDER BY CompanyName"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Customers] SET [CompanyName] = @CompanyName, [ContactName] = @ContactName" & _
                ", [ContactTitle] = @ContactTitle, [Address] = @Address, [City] = @City, [PostalC" & _
                "ode] = @PostalCode, [Country] = @Country WHERE (([CompanyName] = @Original_Compa" & _
                "nyName) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactNam" & _
                "e] = @Original_ContactName)) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] I" & _
                "S NULL) OR ([ContactTitle] = @Original_ContactTitle)) AND ((@IsNull_Address = 1 " & _
                "AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_City = " & _
                "1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_PostalCode = 1" & _
                " AND [PostalCode] IS NULL) OR ([PostalCode] = @Original_PostalCode)) AND ((@IsNu" & _
                "ll_Country = 1 AND [Country] IS NULL) OR ([Country] = @Original_Country)) AND ([" & _
                "Identfier] = @Original_Identifier));" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "SELECT CompanyName, ContactName, ContactTi" & _
                "tle, Address, City, PostalCode, Country, Identfier AS Identifier FROM Customers " & _
                "WHERE (Identfier = @Identfier) ORDER BY CompanyName"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Identfier", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "Identifier", Global.System.Data.DataRowVersion.Current, False, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.NorthWindNew.My.MySettings.Default.NORTHWNDConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CompanyName, ContactName, ContactTitle, Address, City, PostalCode, Country" & _
                ", Identfier AS Identifier" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM     Customers" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "ORDER BY CompanyName ASC"
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As NORTHWNDDataSet.CustomersDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As NORTHWNDDataSet.CustomersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataTable As NORTHWNDDataSet.CustomersDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataSet As NORTHWNDDataSet) As Integer
        ...
        Public Overridable Overloads Function Delete(ByVal Original_CompanyName As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_Address As String, ByVal Original_City As String, ByVal Original_PostalCode As String, ByVal Original_Country As String, ByVal Original_Identifier As Integer) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_ContactTitle, String)
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_PostalCode, String)
            End If
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(13).Value = CType(Original_Identifier, Integer)
        ...
        Public Overridable Overloads Function Insert(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal PostalCode As String, ByVal Country As String) As Integer
        ...
        Public Overridable Overloads Function Update( _
                    ...
                    ByVal Identfier As Integer) As Integer
            If (CompanyName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CompanyName")
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_ContactName, String)
            End If
            If (Original_ContactTitle Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(Original_ContactTitle, String)
            End If
            If (Original_Address Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(17).Value = CType(Original_PostalCode, String)
            End If
            If (Original_Country Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_Identifier, Integer)
            Me.Adapter.UpdateCommand.Parameters(21).Value = CType(Identfier, Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
        Public Overridable Overloads Function Update(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal PostalCode As String, ByVal Country As String, ByVal Original_CompanyName As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_Address As String, ByVal Original_City As String, ByVal Original_PostalCode As String, ByVal Original_Country As String, ByVal Original_Identifier As Integer) As Integer
            Return Me.Update(CompanyName, ContactName, ContactTitle, Address, City, PostalCode, Country, Original_CompanyName, Original_ContactName, Original_ContactTitle, Original_Address, Original_City, Original_PostalCode, Original_Country, Original_Identifier, Original_Identifier)
        End Function
    End Class
