...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <section class="featured">
        <div class="content-wrapper">
            ...
            <p>
                This sample shows how to create, issue and use a custom security token in an ASP.Net Web
                Application. For a more complete explanation of how the sample works, please refer to the readme.html file 
                in the VS solution or to the sample’s <a href="http://code.msdn.microsoft.com/Custom-Token-ddce2f55">online description</a>.
            </p>
        </div>
    </section>
</asp:Content>
