...
<p>The Data Annotation feature got introduced in.Net 3.5 and the <strong><em>System.ComponentModel.DataAnnotations</em></strong> namespace contains the classes that are used as data attributes.</p>
...
<div class="pluginLinkHolder"><span class="pluginEditHolderLink">Edit</span>|<span class="pluginRemoveHolderLink">Remove</span></div>
<span class="hidden">csharp</span>
<pre class="hidden">using Model.Employee;
