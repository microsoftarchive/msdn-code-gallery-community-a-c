    ...
    <table style="width: 100%; height: 100%">
        ...
        <tr>
            <td style="border: solid 1px Black; padding-top: 10px; padding-left: 10px; padding-right: 10px; padding-bottom: 0px">
                <table style="width: 100%; height: 100%">
                    <tr>
                        <td style="font-size: 14px; font-weight: bold; height: 20px; padding-bottom: 15px; padding-top: 5px">Add Page Numbering in HTML
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%;">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td style="font-weight: bold">HTML String with Page Numbering to Add in Footer
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
