...
InstallPreReqs "scripts\frameworks\angular-route.min.js" "http://ajax.googleapis.com/ajax/libs/angularjs/1.2.15/angular-route.min.js" "AngularJs dependencies"
