...
<div class="pluginLinkHolder"><span class="pluginEditHolderLink">Edit</span>|<span class="pluginRemoveHolderLink">Remove</span></div>
<span class="hidden">csharp</span>
<pre class="hidden">Scaffold-DbContext &quot;Server= YourSqlServerName;Database=StudentsDB;user id= YourSqlUID;password= YourSqlPassword;Trusted_Connection=True;MultipleActiveResultSets=true&quot; Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -Tables StudentMasters</pre>
<div class="preview">
...
<pre class="hidden">@using BLAZORASPCORE.Shared
...
<pre class="hidden">&lt;h1&gt; ASP.NET Core BLAZOR CRUD demo for Studetns&lt;/h1&gt;
&lt;hr /&gt;
