...
namespace shanuMVCUserRoles
{
    ...
    public partial class AttendanceDBEntitiesNew : DbContext
    {
        public AttendanceDBEntitiesNew()
            : base("name=AttendanceDBEntitiesNew")
        {
        }
        ...
        public virtual ObjectResult<USP_MenubyUserRoll_Select_Result> USP_MenubyUserRoll_Select(string rolename)
        {
            var rolenameParameter = rolename != null ?
                new ObjectParameter("Rolename", rolename) :
                new ObjectParameter("Rolename", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_MenubyUserRoll_Select_Result>("USP_MenubyUserRoll_Select", rolenameParameter);
        }
