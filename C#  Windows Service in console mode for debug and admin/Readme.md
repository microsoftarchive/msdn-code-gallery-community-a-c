...
<pre class="hidden">    // On est en mode int&eacute;ractif et d&eacute;bogage ?
    if (Environment.UserInteractive &amp;&amp; System.Diagnostics.Debugger.IsAttached)
    {
        // Simule l'ex&eacute;cution des services
        RunInteractiveServices(ServicesToRun);
    }
    else
    {
        // Ex&eacute;cute les services normalement
        ServiceBase.Run(ServicesToRun);
    }
</pre>
<div class="preview">
<pre class="csharp">&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">//&nbsp;On&nbsp;est&nbsp;en&nbsp;mode&nbsp;int&eacute;ractif&nbsp;et&nbsp;d&eacute;bogage&nbsp;?</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__keyword">if</span>&nbsp;(Environment.UserInteractive&nbsp;&amp;&amp;&nbsp;System.Diagnostics.Debugger.IsAttached)&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;{&nbsp;
